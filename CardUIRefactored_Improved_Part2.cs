    ...
    public class CardUI : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
    {
        ...
        public void SetMode(CardUIMode newMode)
        {
            ...
            if (currentStrategy != null && currentContext != null)
            {
                ...
                Debug.Log($"[CardUI] Mode changed to: {mode}");
            }
            else
            {
                Debug.LogError($"[CardUI] Failed to create strategy or context for mode: {mode}");
            }
        }
        ...
        public void SetDraggable(bool draggable)
        {
            ...
            Debug.Log($"[CardUI] SetDraggable({draggable})");
        }
        ...
        public void SetInteractable(bool interactable)
        {
            ...
            Debug.Log($"[CardUI] SetInteractable({interactable})");
        }
        ...
        public void SetupForDeck(CardData card, int count, Game.UI.Panels.DeckBuilderPanel panel)
        {
            ...
            // 덱 패널 설정
            if (currentContext is CardUIBuilderContext builderContext)
            {
                builderContext.DeckPanel = panel;
            }
        ...
        {
            if (!isDraggable || currentStrategy == null || cardData == null) return;
